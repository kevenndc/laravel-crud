...
@section('content')
    ...
    <div class="flex justify-between items-center mb-3">
        ...
        <div>
            ...
            <a href="{{ route('posts.index', ['filter' => 'published']) }}" class="text-blue-400 text-sm mr-2">Published ({{ $counts['published'] }})</a>
            <a href="{{ route('posts.index', ['filter' => 'drafts']) }}" class="text-blue-400 text-sm mr-2">Drafts ({{ $counts['drafts'] }})</a>
            <a href="{{ route('posts.index', ['filter' => 'trashed']) }}" class="text-red-500 text-sm">Trash ({{ $counts['trashed'] }})</a>
        </div>
        <div>
