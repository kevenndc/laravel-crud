...
@section('content')
    ...
    <div class="bg-white rounded-lg p-4 shadow-md">
        @if($posts->isNotEmpty())
            <table class="w-full">
                <thead>
                    <x-sortable-th route="admin.posts.index" column="id" class="pl-3 text-left">ID</x-sortable-th>
                    <x-sortable-th route="admin.posts.index" column="title" class="px-3 text-left w-5/12">Title</x-sortable-th>
                    <x-sortable-th route="admin.posts.index" column="created_at" class="px-3 text-left">Date</x-sortable-th>
